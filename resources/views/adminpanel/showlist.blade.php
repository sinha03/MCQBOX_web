@extends('adminpanel.add_course')
 ...
 <div class="container-contact100">
  ...
  @foreach($list as $list)
            <form id="formElem" class="contact100-form validate-form"  name="formElem" method="POST" action="{!! route('add_question', array('id' => $list->id)) !!}">
       ...
       <a class="home1" href="/list_course/{{$list->id}}">Back Home</a>
