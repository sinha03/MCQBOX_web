...
<html lang="en" class="no-js">
  <head>
    ...
    <body>
       ...
       <header id="header">
         <div class="box-left">
         @foreach($user11 as $user1)
                 

                        <div class="menu" >   
                           <a href="/list_course/{{ $user1->id }}">{!! Html::image('quiz1/images/left1.png', 'a picture')  !!}</a>
                        </div>
               @endforeach      
...
<div id="2nd_chapter" >
  ...
  <tr>
    ...
    <td>
      <a class="action" href="<?php echo url('delete_chapter');?>/<?php echo $question_id;?>/<?php echo $check_question;?>">delete</a></td>
      <td><a class="action1" href="<?php echo url('edit_chapter');?>/<?php echo $question_id;?>/<?php echo $check_question;?>">update</a>
